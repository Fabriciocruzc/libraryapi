package io.github.fabriciocruzc.libraryapi.controller.common;

import io.github.fabriciocruzc.libraryapi.controller.dto.ErroCampo;
import io.github.fabriciocruzc.libraryapi.controller.dto.ErroResposta;
import io.github.fabriciocruzc.libraryapi.exceptions.CampoInvalidoException;
import io.github.fabriciocruzc.libraryapi.exceptions.OperacaoNaoPermitidaException;
...
public class GlobalExceptionHandler {
    ...
    public ErroResposta handleErrosNaoTratado(RuntimeException e){
        return new ErroResposta(HttpStatus.INTERNAL_SERVER_ERROR.value(),
                "Ocorreu um erro inesperador. Entre en contato com o administrador",
                List.of());
    }
}
