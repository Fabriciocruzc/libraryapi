...
import io.github.fabriciocruzc.libraryapi.controller.mappers.LivroMapper;
...
import io.github.fabriciocruzc.libraryapi.service.LivroService;
...
public class LivroController implements GenericController {
    ...
    @GetMapping("{id}")
    public  ResponseEntity<ResultadoPesquisaLivroDTO> obterDetalha(@PathVariable("id") String id){
